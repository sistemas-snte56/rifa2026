            ...
            <div class="p-8 text-center">
                ...
                <div class="mt-8 space-y-4">
                    ...
                    <p class="text-sm text-gray-700 bg-gray-50 p-4 rounded-lg border border-gray-200">
                        Toma una <strong>captura de pantalla</strong> o <strong>imprime</strong> esta página. Deberás presentar este folio para reclamar tu premio en caso de resultar ganador.
                    </p>
                    
                    <button onclick="window.print()" class="w-full py-3 px-6 bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold rounded-xl transition flex items-center justify-center gap-2">
                ...
                <div class="mt-8 pt-6 border-t border-gray-100">
                    <a href="{{ route('registro-rifa') }}" class="text-[#89194b] font-bold hover:underline">
                        Regresar al Inicio
                    </a>
                </div>
            </div>
